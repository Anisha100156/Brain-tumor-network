const Waves = () => {
    return (
      <div className="relative w-full h-[320px] text-white">
        {/* Mission Quote */}
        <div className="absolute z-10 top-30 left-7 md:left-80 max-w-4xl">
          <h2 className="text-green-400 font-bold text-lg md:text-2xl mb-2">
            Our Mission
          </h2>
          <p className="font-bold text-xl md:text-2xl leading-snug md:leading-relaxed">
          A brain tumor diagnosis can feel overwhelming, filled with uncertainty and tough decisions. In times like these, what matters most is having clear information and compassionate support you can trust. Whether you're just beginning to understand your condition or exploring treatment options, we’re here to help you make sense of it all.
  </p>
  <br></br>
