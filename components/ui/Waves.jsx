  ...
  return (
    <div className="relative w-full h-[320px] text-white">
      ...
      <div className="absolute z-10 top-30 left-7 md:left-80 max-w-4xl">
        ...
        A brain tumor diagnosis can feel overwhelming, filled with uncertainty and tough decisions. In times like these, what matters most is having clear information and compassionate support you can trust.
</p>
