...
import HelpSections from "@/components/ui/helpsing";
import SocialWorkServices from "@/components/ui/symptoms";

const words = "Accurate insights to guide your care journey";
...
export default function BrainTumorNetwork() {
  ...
  return (
    <>
      {/* Main Hero Section */}
      <div className="relative h-180 w-full bg-cover bg-center bg-[url(/learns.jpg)]">
